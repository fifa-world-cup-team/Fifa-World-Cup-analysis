...
### 0. Vérifier l'accès RapidAPI World Football Ranking
Le script est prêt, mais l'appel live retourne encore `403 Forbidden`.
Il faut vérifier que l'API est bien activée dans le compte RapidAPI.
